...
public:
    ...
    void draw()
    {
        // float lux = ((_x - _width/2) - _width/100)/50;
        // float luy = -((_y + _width/2) - _width/100)/50;

        // float rux = ((_x + _width/2)  - _width/100)/50;
        // float ruy = -((_y + _width/2)  - _width/100)/50;

        // float ldx = ((_x - _width/2)  - _width/100)/50;
        // float ldy = -((_y - _width/2)  - _width/100)/50;

        // float rdx = ((_x + _width/2)  - _width/100)/50;
        // float rdy = -((_y - _width/2) - _width/100)/50;
